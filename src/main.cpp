...
//    SDL_GL_SetAttribute(SDL_GL_STENCIL_SIZE, 8);
    ...
    int width = 1280;
    int height = 720;
    SDL_Window* window = SDL_CreateWindow("GameEngine", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, width, height, window_flags);
...
//    SDL_GL_SetSwapInterval(1);
    ...
    Texture texture(imgPath02);
    shaderProgram.setUniform("tex", texture);

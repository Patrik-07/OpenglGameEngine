...
Model ModelLoader::load(const std::string& modelPath) {
    directory = "";
...
Geometry ModelLoader::processGeometry(aiMesh *mesh) {
...
std::vector<unsigned int> ModelLoader::processIndices(aiMesh *mesh) {
    std::vector<unsigned int> indices;
...
std::vector<Texture> ModelLoader::processTexturesByType(aiMaterial *material, aiTextureType aiType, unsigned int type) {
    std::vector<Texture> textures;
